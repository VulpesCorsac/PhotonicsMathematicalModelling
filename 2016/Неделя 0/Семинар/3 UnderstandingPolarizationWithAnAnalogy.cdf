...
NotebookDataLength[     80744,       1614]
NotebookOptionsPosition[     53528,       1029]
NotebookOutlinePosition[     79798,       1590]
CellTagsIndexPosition[     79687,       1584]
WindowTitle->Understanding Polarization with an Analogy
WindowFrame->Normal*)
...
Cell["Understanding Polarization with an Analogy", "DemoTitle"],
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Phi]$$ = 0, Typeset`show$$ = True, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Phi]$$], 0, "move rope"}, 0, 6 Pi}}, 
    Typeset`size$$ = {450., {223., 227.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Phi]$724489$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`\[Phi]$$ = 0}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[Phi]$$, $CellContext`\[Phi]$724489$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Graphics3D[{
          Polygon[
           ...
           Table[{{$CellContext`\[Delta], 0, 0}, {$CellContext`\[Delta], 0, 
              1}, {0.1 + $CellContext`\[Delta], 0, 1.2}, {
             0.2 + $CellContext`\[Delta], 0, 1}, {
             0.2 + $CellContext`\[Delta], 0, 1}, {
             0.2 + $CellContext`\[Delta], 0, 0}}, {$CellContext`\[Delta], 0, 
             1.25, 0.25}]], 
          Polygon[
           
           Table[{{$CellContext`\[Delta], 1, 0}, {$CellContext`\[Delta], 1, 
              1}, {0.1 + $CellContext`\[Delta], 1, 1.2}, {
             0.2 + $CellContext`\[Delta], 1, 1}, {
             0.2 + $CellContext`\[Delta], 1, 1}, {
             0.2 + $CellContext`\[Delta], 1, 0}}, {$CellContext`\[Delta], 0, 
             1.25, 0.25}]], 
          Polygon[
           
           Table[{{$CellContext`\[Delta], 2, 0}, {$CellContext`\[Delta], 2, 
              1}, {0.1 + $CellContext`\[Delta], 2, 1.2}, {
             0.2 + $CellContext`\[Delta], 2, 1}, {
             0.2 + $CellContext`\[Delta], 2, 1}, {
             0.2 + $CellContext`\[Delta], 2, 0}}, {$CellContext`\[Delta], 0, 
             1.25, 1}]], 
          Map[Polygon, 
           Table[{{0, $CellContext`x, $CellContext`\[Delta]}, {
             0, $CellContext`x, 0.15 + $CellContext`\[Delta]}, {
             1.5, $CellContext`x, 0.15 + $CellContext`\[Delta]}, {
             1.5, $CellContext`x, $CellContext`\[Delta]}}, {$CellContext`\
\[Delta], 0, 0.8, 0.8}, {$CellContext`x, 0, 1}]], 
          Polygon[
           
           Table[{{0, 2, $CellContext`\[Delta]}, {
             0, 2, 0.15 + $CellContext`\[Delta]}, {
             1.25, 2, 0.15 + $CellContext`\[Delta]}, {
             1.25, 2, $CellContext`\[Delta]}}, {$CellContext`\[Delta], 0, 
             0.84, 0.21}]], 
          Thickness[0.005], 
          
          Line[{{0.75, 
             2, (Exp[(-Pi)/2] 0.2) Sin[10 Pi + $CellContext`\[Phi]$$ + 5 Pi] + 
             0.6}, {0.75, 3, 0.6}}], 
          RGBColor[0.6, 0.73, 0.36], 
          
          Polygon[{{-0.4, -1.2, 0}, {-0.4, 3.5, 0}, {1.9, 3.5, 0}, {
            1.9, -1.2, 0}}], Brown, 
          
          Cylinder[{{0.75, 2.75 + 0.3525, 0}, {0.75, 2.75 + 0.3525, 0.6}}, 
           0.3525], 
          
          Cylinder[{{0.75, 2.75 + 0.3525, 0.6}, {0.75, 2.75 + 0.3525, 1.5}}, 
           0.3525], {
           Thickness[0.01], 
           Line[{{0.6, -1.2, 0}, {0.75, -1.2, 0.5}}], 
           Line[{{0.9, -1.2, 0}, {0.75, -1.2, 0.5}}], 
           Line[{{0.75, -1.1, 1}, {0.75, -1.2, 0.5}}], 
           
           Line[{{0.75, -1.1, 1}, {
             0.2 Cos[$CellContext`\[Phi]$$] + 0.75 + 
              0.2 Cos[$CellContext`\[Phi]$$], -1, 
              0.2 Sin[$CellContext`\[Phi]$$] + 0.6}}], 
           Line[{{0.75, -1.1, 1}, {0.55, -1.1, 0.5}}], 
           Line[{{0.75, -1.1, 1}, {0.75, -1.1, 1.1}}], 
           Sphere[{0.75, -1.1, 1.2}, 0.1]}}], 
        ParametricPlot3D[{
         0.2 Cos[$CellContext`\[Theta] + $CellContext`\[Phi]$$] + 0.75 + 
          0.2 Cos[$CellContext`\[Phi]$$], 0.2 ($CellContext`\[Theta]/Pi) - 1, 
          0.2 Sin[$CellContext`\[Theta] + $CellContext`\[Phi]$$] + 
          0.6}, {$CellContext`\[Theta], 0, 5 Pi}, PlotStyle -> 
         Thickness[0.005]], 
        ParametricPlot3D[{
         0.75, 0.2 ($CellContext`\[Theta]/
           Pi), (Exp[(-$CellContext`\[Theta])/20] 0.2) 
           Sin[$CellContext`\[Theta] + $CellContext`\[Phi]$$ + 5 Pi] + 
          0.6}, {$CellContext`\[Theta], 0, 10 Pi}, PlotStyle -> 
         Thickness[0.005]], PlotRange -> All, Boxed -> False, SphericalRegion -> 
        True, ImageSize -> {450, 450}], 
      "Specifications" :> {{{$CellContext`\[Phi]$$, 0, "move rope"}, 0, 6 
         Pi}}, "Options" :> {}, 
...
Cell["\<\
This analogy, similar to one attributed to Fresnel, provides a way to \
understand the phenomenon of polarization. Imagine a rope tied to a tree at \
one end with a person shaking it with a circular motion at the other end. The \
rope passes through three fences, with vertical bars in the first and the \
second fences and horizontal bars in the third, nearest the tree. \
\>", "ManipulateCaption"],

Cell["\<\
Moving the rope left to right creates waves that would be blocked by the \
fence because the horizontal gap is small. Thus, after the waves pass through \
the first fence, they move only vertically. After the waves pass through the \
third fence, the rope becomes straightened out.\
\>", "ManipulateCaption",
 CellID->94381465],

Cell["\<\
This is a common phenomenon of light known as polarization; the first fence \
plays the role of a polarizer glass and the second one plays the role of a \
glass called the analyzer.\
\>", "ManipulateCaption",
 CellID->373353492],
...
Cell[TextData[{
 ButtonBox["Wave",
  ...
  ButtonNote->"http://scienceworld.wolfram.com/physics/Wave.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Light",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Light.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Light.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Polarization",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Polarization.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Polarization.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
UnderstandingPolarizationWithAnAnalogy&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/UnderstandingPolarizationWithAnAnalogy/\
UnderstandingPolarizationWithAnAnalogy-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Understanding Polarization with an Analogy",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
UnderstandingPolarizationWithAnAnalogy/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/UnderstandingPolarizationWithAnAnalogy/\
"],
 "\"",
...
UnderstandingPolarizationWithAnAnalogy/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
UnderstandingPolarizationWithAnAnalogy/"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41190, 728, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[41451, 737, 3610, 78, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[52706, 1004, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 79400, 1573},
 {"Copyright", 79595, 1578}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[606, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34937, 590, 63, 0, 70, "DemoTitle"],
Cell[35003, 592, 5191, 111, 70, "Output",
 CellID->662186207],
Cell[40197, 705, 409, 6, 70, "ManipulateCaption"],
Cell[40609, 713, 337, 6, 70, "ManipulateCaption",
 CellID->94381465],
Cell[40949, 721, 238, 5, 70, "ManipulateCaption",
 CellID->373353492],
Cell[41190, 728, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41451, 737, 3610, 78, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45064, 817, 44, 0, 70, "RelatedLinksSection"],
Cell[45111, 819, 470, 15, 70, "RelatedLinks",
 CellID->1763236952],
Cell[45584, 836, 473, 15, 70, "RelatedLinks",
 CellID->1321348321],
Cell[46060, 853, 493, 15, 70, "RelatedLinks",
 CellID->772837420],
Cell[46556, 870, 4855, 90, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51414, 962, 45, 0, 70, "CitationSection"],
Cell[51462, 964, 911, 26, 70, "Citations"],
Cell[52376, 992, 327, 10, 70, "Author"],
Cell[52706, 1004, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature @SqQneGwol8hSu7MA8mkwzbB *)
